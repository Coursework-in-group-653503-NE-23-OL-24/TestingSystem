...
// (DO NOT EDIT: machine generated header) 'FormAddUser.pas' rev: 30.00 (Windows)

#ifndef FormadduserHPP
#define FormadduserHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FORMADDUSER)
using namespace Formadduser;
#endif
#pragma pack(pop)
#pragma option pop
